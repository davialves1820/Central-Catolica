...
export default async function SantoDoDia() {
  ...
  return (
    <Link
      ...
      className="santo-do-dia group flex items-center gap-4 rounded-xl border p-4 transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
      style={{
