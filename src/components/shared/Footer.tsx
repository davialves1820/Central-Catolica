        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="font-body text-sm text-primary-foreground/80">
                Uma comunidade de fé, esperança e caridade ao serviço do Reino
                de Deus.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3 font-body text-sm text-primary-foreground/80">
                ...
                >
                  ...
                  <span>
                    R. Bancário Waldemar de Mesquita Accioly, 16 — Bancários,
                    João Pessoa - PB
                  </span>
                </a>
          ...
          <div className="border-t border-primary-foreground/20 mt-8 pt-6 text-center">
            <p className="font-body text-xs text-primary-foreground/60">
              © {new Date().getFullYear()} Paróquia Santo Menino Jesus de Praga.
