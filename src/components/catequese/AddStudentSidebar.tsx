    ...
    return (
        <div className="bg-white dark:bg-zinc-900 p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    <label htmlFor="student-name" className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">Nome Completo</label>
                    <input
                        id="student-name"
                        type="text"
                        required
                ...
                <div className="space-y-3 pt-2">
                    <label htmlFor="has-baptism" className="flex items-center gap-3 cursor-pointer group">
                    ...
                    <label className="flex items-center gap-3 cursor-pointer group">
                        <div className="relative">
                            <input                                id="has-eucharist"                                type="checkbox"
                                className="peer sr-only"
