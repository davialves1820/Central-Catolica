...
function TextoOracao({ text }: { text: string }) {
...
export default function DetalheOracao({ oracao: prayer, config: cfg, aoFechar: onClose, aoAnterior: onPrev, aoProximo: onNext, temAnterior: hasPrev, temProximo: hasNext }: PropsDetalheOracao) {
    useEffect(() => {
        ...
        <>
            ...
            >
                ...
                <div
                    ...
                    style={{
                        background: `linear-gradient(135deg, hsl(var(--secondary)) 0%, ${cfg.brilho} 100%)`,
                ...
                >
                    <div className="flex-1 min-w-0">
                        <span
                            ...
                            style={{ color: cfg.cor, borderColor: cfg.borda, background: cfg.brilho }}
                        >
                            {prayer.categoria}
                        </span>
                ...
                >
                    <button
                        ...
                        style={{
                            borderColor: hasPrev ? cfg.borda : "hsl(var(--border))",
                            color: hasPrev ? cfg.cor : "hsl(var(--muted-foreground))",
                            background: hasPrev ? cfg.brilho : "transparent",
                        }}
                    >
                    ...
                    <button
                        ...
                        className="flex items-center gap-1.5 text-xs font-body font-bold px-3 py-2 rounded-lg border transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary disabled:opacity-25 disabled:cursor-not-allowed"
                        style={{
                            borderColor: hasNext ? cfg.borda : "hsl(var(--border))",
                            color: hasNext ? cfg.cor : "hsl(var(--muted-foreground))",
                            background: hasNext ? cfg.brilho : "transparent",
                        }}
                    >
                        Próxima
