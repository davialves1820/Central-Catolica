          ...
          {!success ? (
            <form action={onSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={isPending}
                className="w-full bg-primary hover:bg-accent text-white font-heading font-bold py-4 rounded-2xl shadow-xl shadow-primary/20 transition-all active:scale-[0.98] flex items-center justify-center gap-2 group disabled:opacity-70"
              >
                {isPending ? (
            ...
            <motion.div
              ...
              className="bg-primary/5 border border-primary/10 rounded-2xl p-6 mb-6"
            >
